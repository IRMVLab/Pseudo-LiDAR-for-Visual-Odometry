...
__C.LI_FUSION.POINT_CHANNELS = [16, 32, 64, 128]

__C.LI_FUSION.DeConv_Reduce = [16, 16, 16, 16]
__C.LI_FUSION.DeConv_Kernels = [1,2,4,8]#[2, 4, 8, 16]
__C.LI_FUSION.DeConv_Strides = [1,2,4,8]#[2, 4, 8, 16]
...
__C.RPN.USE_BN = True
__C.RPN.NUM_POINTS = 2048

__C.RPN.SA_CONFIG = edict()
__C.RPN.SA_CONFIG.NPOINTS = [2048, 1024, 256, 64]
