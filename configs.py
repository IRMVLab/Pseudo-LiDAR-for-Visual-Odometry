...
def pwclonet_args():
    ...
    parser.add_argument('--data_root', default='/dataset/Pesudo_IGEV', help='Dataset directory [default: /dataset]')
    parser.add_argument('--log_dir', default='log_train', help='Log dir [default: log_train]')

    parser.add_argument('--num_points', type=int, default=479232, help='Point Number [default: 2048]')

    parser.add_argument('--H_input', type=int, default=384, help='H Number [default: 64]')
    parser.add_argument('--W_input', type=int, default=1248, help='W Number [default: 1800]')

    parser.add_argument('--max_epoch', type=int, default=1001, help='Epoch to run [default: 151]')
    ...
    parser.add_argument('--ckpt', type=str, default=None)#'./pretrain_weights/pwc_model_065_-24.095057.pth.tar'
